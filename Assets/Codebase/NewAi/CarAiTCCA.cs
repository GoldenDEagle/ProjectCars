...
namespace Assets.Codebase.NewAi
{
    public class CarAiTCCA : MonoBehaviour
    {
        ...
        [SerializeField] private TCCAPlayer m_CarController;    // Reference to actual car controller we are controlling
        ...
        private void Awake()
        {
            ...
            //m_CarController = GetComponent<TCCAPlayer>();
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                float maxSpeed = m_CarController.getWheelsMaxSpeed();
                if (m_Rigidbody.velocity.magnitude > maxSpeed * 0.1f)
                {
        ...
        private void MoveCar(float motorValue, float steeringValue, bool handbrake = false)
        {
            m_CarController.setMotor(motorValue);
            m_CarController.setSteering(steeringValue);
            m_CarController.setHandbrake(handbrake);
        }
