...
namespace Assets.DavidJalbert.TinyCarControllerAdvance.Scripts.Helpers
{
    public class TCCAInputBasedCar : MonoBehaviour
    {
        ...
        void Update()
        {
            if (enableInput && carController != null)
            {
                ...
                carController.Move(steeringDelta, motorDelta, motorDelta, 0f);
